...
if __name__ == '__main__':
    ...
    image_path = "/home/youtian/Documents/pro/pyCode/CFFNet-V2/data/dataset/IRSTD-1k/images/XDU5.png"  # 替换为你的图像路径
    ...
    plt.imshow(result[:, :, 0], cmap='gray')  # 显示第一个通道或使用彩色
